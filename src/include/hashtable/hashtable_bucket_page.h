...
#define BUCKET_PAGE_KEY_TYPE GenericKey<KEY_SIZE>
#define BUCKET_PAGE_VALUE_TYPE GenericValue<VALUE_SIZE>
#define BUCKET_PAGE_KEY_COMPARATOR GenericComparator<KEY_SIZE>
...
#define BUCKET_PAGE_SIZE ((PAGE_SIZE - BUCKET_PAGE_HEADER_SIZE) / sizeof(BUCKET_PAGE_MAPPING_TYPE))
